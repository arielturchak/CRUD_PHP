...
<form  action="./includes/validar.php" method="POST"><!--aquí pongo a donde voy a mandar los datos del formulario-->
<div id="login" >
        <div class="container">
                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                           ...
                           <br>
                               ...
                               name="registrar"><!--registar es lo que voy a enviar a validar-->
